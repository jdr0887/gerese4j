...
public class GeReSe4jBuild_36_1_Manager {

    private static final Logger logger = LoggerFactory.getLogger(GeReSe4jBuild_36_1_Manager.class);

    private Set<String> indexSet = null;

    private final Map<String, ReferenceSequence> referenceSequenceCache = new HashMap<>();

    private static GeReSe4jBuild_36_1_Manager instance;

    public static GeReSe4jBuild_36_1_Manager getInstance() {
        if (instance == null) {
            instance = new GeReSe4jBuild_36_1_Manager();
            instance.init();
        }
        return instance;
    }

    private GeReSe4jBuild_36_1_Manager() {
        super();
    }
