package org.renci.gerese4j.build_36_3.util;
...
public class DownloadAndSerializeReferenceSequences implements Runnable {
    ...
    private static final BuildType buildType = BuildType.BUILD_36_3;
    ...
    public void run() {
        ...
        File serializationDir = new File("src/main/resources/org/renci/gerese4j/build_36_3");
