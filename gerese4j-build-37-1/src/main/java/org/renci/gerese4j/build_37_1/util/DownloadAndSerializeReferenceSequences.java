package org.renci.gerese4j.build_37_1.util;
...
public class DownloadAndSerializeReferenceSequences implements Callable<File> {
    ...
    public File call() throws Exception {
        ...
        File serFile = new File(serializationDir, String.format("reference_sequences_%s.ser", BuildType.BUILD_37_1.getVersion()));
