...
import org.renci.gerese4j.core.impl.GeReSe4jBuild_36_1;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class Build_36_1_Test {

    private static final Logger logger = LoggerFactory.getLogger(Build_36_1_Test.class);

    @Test
    public void testPosition() throws Exception {
        logger.info("start initializing");
        GeReSe4jBuild gereseMgr = GeReSe4jBuild_36_1.getInstance();
